...
function dl_enqueue_style() {
	...
	/* Register Scripts */
	wp_register_style( 'bootstrap_css', 'https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous', null, $theme_data->get( '4.1.3' ), 'screen' );
	wp_register_style( 'style-masonry', get_theme_file_uri( '/assets/css/style-masonry.css'), null, $theme_data->get( '1.0' ), 'screen' );
